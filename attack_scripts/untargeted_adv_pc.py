...
from models import *
from attacks.untargeted import CWUAdvPC
from attacks.utils import CrossEntropyAdvLoss, UntargetedLogitsAdvLoss, ChamferDist
...
if __name__ == "__main__":
    ...
    test_set = ModelNet40Dataset(test_X, test_y, transform=to_tensor_transform)
    ...
    save_path = f"../data/adv_samples/uadvpc/{args.model.lower()}/test"
