...
from models import *
from attacks.targeted.aof import CWTAOF
from attacks.utils import CrossEntropyAdvLoss, LogitsAdvLoss, L2Dist, ClipPointsLinf
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Targeted AOF')
    ...
    parser.add_argument('--num_category', default=40, type=int, choices=[15, 40],  help='training on ModelNet10/40')
    ...
    if args.model.lower() == 'dgcnn':
        model = DGCNN(args.emb_dims, args.k, output_channels=args.num_category)
    elif args.model.lower() == 'pointnet':
        model = PointNetCls(k=args.num_category, feature_transform=args.feature_transform)
    elif args.model.lower() == 'pointnet2':
        model = PointNet2ClsSsg(num_classes=args.num_category)
    elif args.model.lower() == 'pct':
        model = PCT(output_channels=args.num_category)
    else:
    ...
    test_set = ModelNet40Dataset(test_X, test_y, transform=test_transforms, t=test_target)
    ...
    save_path = f"../data/adv_samples/taof/{args.model.lower()}/test"
