...
from models import *
from attacks.targeted.add import CWAdd
from attacks.utils import CrossEntropyAdvLoss, LogitsAdvLoss, ChamferDist, HausdorffDist
...
def attack():
    ...
    for pc, label, target in tqdm(test_loader):
        ...
        _, best_pc, success_num = attacker.attack(pc, target)
...
if __name__ == "__main__":
    ...
    save_path = f"../data/adv_samples/add_{args.dist_func}/{args.model.lower()}/test"
