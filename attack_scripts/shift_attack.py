...
from models import *
from attacks.targeted.shift import CWPerturb
from attacks.utils import CrossEntropyAdvLoss, LogitsAdvLoss, L2Dist
...
if __name__ == "__main__":
    ...
    save_path = f"../data/adv_samples/shift/{args.model.lower()}/test"
