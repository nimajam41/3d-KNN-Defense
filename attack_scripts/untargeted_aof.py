...
from models import *
from attacks.untargeted.aof import CWAOF
from attacks.utils import L2Dist, ClipPointsLinf, UntargetedLogitsAdvLoss
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='AOF')
    ...
    save_path = f"../data/adv_samples/uaof/{args.model.lower()}/test"
