"""Adopted from https://github.com/Wuziyi616/IF-Defense/blob/main/baselines/model"""
...
class PointNetSetAbstractionMsg(nn.Module):
    ...
    def forward(self, xyz, points):
        ...
        S = self.npoint
        new_xyz = index_points(xyz, farthest_point_sample(xyz, S))  # [B, N, C]
        new_points_list = []
...
class PointNet2ClsSsg(nn.Module):
    ...
    def forward(self, xyz, return_global=False):
        B, _, _ = xyz.shape
        l1_xyz, l1_points = self.sa1(xyz, None)
        l2_xyz, l2_points = self.sa2(l1_xyz, l1_points)
        l3_xyz, l3_points = self.sa3(l2_xyz, l2_points)
